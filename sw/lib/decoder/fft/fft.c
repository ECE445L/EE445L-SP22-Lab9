...
extern void cr4_fft_64_stm32(uint16_t out[], uint16_t in[], uint16_t n);
extern void cr4_fft_256_stm32(uint16_t out[], uint16_t in[], uint16_t n);
extern void cr4_fft_1024_stm32(uint16_t out[], uint16_t in[], uint16_t n);

void fft_64(uint16_t out[], uint16_t in[]) {
    cr4_fft_64_stm32(out, in, 64);
}

void fft_256(uint16_t out[], uint16_t in[]) {
    cr4_fft_64_stm32(out, in, 256);
}

void fft_1024(uint16_t out[], uint16_t in[]) {
